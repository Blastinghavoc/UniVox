...
public class VoxelTypeManager : MonoBehaviour
{
    ...
    public void Initialise() 
    {
        ...
        //Generate definition for Air
        //var AirDefinition = (SOVoxelTypeDefinition)ScriptableObject.CreateInstance(typeof(SOVoxelTypeDefinition));
        //AirDefinition.DisplayName = "Air";
        //AirDefinition.meshDefinition = new VoxelMeshDefinition()
        //{
        //    Faces = new VoxelFaceDefinition[6] {
        //            new VoxelFaceDefinition(){isSolid = false},
        //            new VoxelFaceDefinition(){isSolid = false},
        //            new VoxelFaceDefinition(){isSolid = false},
        //            new VoxelFaceDefinition(){isSolid = false},
        //            new VoxelFaceDefinition(){isSolid = false},
        ...
        //        }
        //};
        //AirDefinition.FaceTextures = null;
        //typeData.Add(new VoxelTypeData() { definition=AirDefinition,zIndicesPerFace=null});//Add special entry for air
